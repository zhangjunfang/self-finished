...
<html>
  <head>
    <base href="${__base}">
    <title>测试 REST Convention</title>
  ...
  <script type="text/javascript">
	...
	$(function($) {
		$("#query").click(function() {
			var href		= $("base:first").attr("href") + "user-2/";
  ...
  <div align="right">
    ...
    <div align="center">
    	...
    	<h2>查询用户</h2>
    	<table>
    		<tr><td>姓名:</td><td><input type="text" name="name" id="name"
    			<c:if test="${__action.fromQuery && not empty __action.name}"> value="${__action.name}"</c:if>
    		>&nbsp;</td>
	   			<td>工作年限:</td><td><select name="experience" id="experience">
    				<option value="0"
    	...
    	<br>
    	<c:if test="${__action.fromQuery}">
    	<table border="1" cellpadding="10" cellspacing="0">
    	<tr><th>ID</th><th>姓 名</th><th>年 龄</th><th>性 别</th><th>工作年限</th><th>兴趣爱好</th><th>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th></tr>
    	<c:if test="${not empty __rest_model}">
    	<c:forEach items="${__rest_model}" var="it" varStatus="st">
    		<tr align="center">
    			<td>${it.id}&nbsp;</td>
    			<td>${it.name}&nbsp;</td>
    			<td>${it.age}&nbsp;</td>
    			...
    			&nbsp;</td>
    			<td><a href="user-2/${it.id}?__rest_method=delete">删 除</a>
    			</td>
    		</tr>
    	</c:forEach>
    	</c:if>
