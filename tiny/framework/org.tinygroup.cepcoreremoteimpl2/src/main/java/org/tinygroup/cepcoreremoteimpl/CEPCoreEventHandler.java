...
public class CEPCoreEventHandler {
	...
	public static String NODE_REG_TO_SC_SERVICE_VERSION_KEY = "node_regto_sc_services_version";
	...
	public static String SC_TO_NODE_SERVICE_VERSION_KEY = "sc_regto_node_services_version";
	// 存放请求传递中的节点列表
