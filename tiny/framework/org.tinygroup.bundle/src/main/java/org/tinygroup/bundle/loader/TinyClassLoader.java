...
public class TinyClassLoader extends URLClassLoader {
    /**
     * 当前TinyClassLoader中存放的jar包列表
     */
    private FileObject[] fileObjects = null;
    /**
     * 依赖的TinyClassLoader列表
     */
    ...
    public Class<?> loadClass(String name) throws ClassNotFoundException {
        //首先到依赖的TinyClassLoader中查找，如果查找不到，才在自己里面找
    ...
    /**
     * 返回Jar包对应文件的FileObject数组，如果存在依赖的TinyClassLoader，
     * 也返回依赖的TinyClassLoader包含的Jar对应的FileObject
     *
     * @return
     */
