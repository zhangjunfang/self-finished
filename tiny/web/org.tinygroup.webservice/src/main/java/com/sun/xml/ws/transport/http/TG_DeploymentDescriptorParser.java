...
import com.sun.xml.ws.server.TG_EndpointFactory;
 ...
 */
public class TG_DeploymentDescriptorParser<A> {
     ...
     */
    public TG_DeploymentDescriptorParser(ClassLoader cl, ResourceLoader loader, Container container, AdapterFactory<A> adapterFactory) throws MalformedURLException {
        classLoader = cl;
        this.loader = loader;
    ...
    public Map<String, SDDocumentSource> getDocs() {
		return docs;
	}
...
//            );
	 ...
	 public static <T> WSEndpoint<T> create(
			...
			final WSEndpoint<T> endpoint = 
		            TG_EndpointFactory.createEndpoint(
