 ...
 */
public class TG_EPRSDDocumentFilter implements SDDocumentFilter {
    private final TG_WSEndpointImpl<?> endpoint;
    //initialize lazily
    List<BoundEndpoint> beList;
    public TG_EPRSDDocumentFilter(@NotNull TG_WSEndpointImpl<?> endpoint) {
        this.endpoint = endpoint;
    }

    private @Nullable TG_WSEndpointImpl<?> getEndpoint(String serviceName, String portName) {
