...
<html>
  ...
  <div align="right">
    ...
    <br>
    <div align="center">
    	<form action="test/dao/createUser2.action" method="post">
    		<h2>创建新用户</h2>
    		<table>
    	...
    	<hr>
    	<form action="test/dao/queryUser2.action" method="post">
    		<h2>查询用户</h2>
    		<table>
    	...
    	<c:forEach items="${__action.users}" var="it" varStatus="st">
    		<tr align="center">
    			...
    			&nbsp;</td>
    			<td><a href="test/dao/deleteUser2.action?id=${it.id}">删 除</a>
    			</td>
    		</tr>
    	</c:forEach>
    	</c:if>
