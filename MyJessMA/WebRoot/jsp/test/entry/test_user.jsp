...
<html>
  ...
  <div align="right">
    ...
    <br>
    <div align="center">
    	<form action="test/entry/user!create.action" method="post">
    		<h2>创建新用户</h2>
    		<table>
    	...
    	<hr>
    	<form action="test/entry/user!query.action" method="post">
    		<h2>查询用户</h2>
    		<table>
    	...
    	<c:forEach items="${__action.users}" var="it" varStatus="st">
    		<tr align="center">
    			...
    			&nbsp;</td>
    			<td><a href="test/entry/user!delete.action?id=${it.id}">删 除</a>
    			</td>
    		</tr>
    	</c:forEach>
    	</c:if>
