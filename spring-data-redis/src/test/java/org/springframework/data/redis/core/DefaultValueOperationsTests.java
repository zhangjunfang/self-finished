...
public class DefaultValueOperationsTests<K, V> {
	...
	public void testIncrementLong() throws Exception {
		...
		assertEquals(Long.valueOf((Long) v1 - 10), valueOps.get(key));
		valueOps.increment(key, -10);
		assertEquals(Long.valueOf((Long) v1 - 20), valueOps.get(key));
	}
	...
	public void testIncrementDouble() {
		...
		valueOps.set(key, v1);
		DecimalFormat twoDForm = (DecimalFormat) NumberFormat.getInstance(Locale.US);
