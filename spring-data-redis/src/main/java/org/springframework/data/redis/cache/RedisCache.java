...
public class RedisCache implements Cache {
	...
	public ValueWrapper get(Object key) {
		return get(new RedisCacheKey<Object>(key).usePrefix(this.cacheMetadata.getKeyPrefix()).withKeySerializer(
	...
	public void put(final Object key, final Object value) {
		...
		put(new RedisCacheElement(new RedisCacheKey<Object>(key).usePrefix(cacheMetadata.getKeyPrefix()).withKeySerializer(
	...
	public ValueWrapper putIfAbsent(Object key, final Object value) {
		...
		return putIfAbsent(new RedisCacheElement(new RedisCacheKey<Object>(key).usePrefix(cacheMetadata.getKeyPrefix())
	...
	public void evict(Object key) {
		evict(new RedisCacheElement(new RedisCacheKey<Object>(key).usePrefix(cacheMetadata.getKeyPrefix()).withKeySerializer(
