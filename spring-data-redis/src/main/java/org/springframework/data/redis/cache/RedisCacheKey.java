 ...
 * @since 1.5
 */
public class RedisCacheKey<T> {

	private final T keyElement;
	private byte[] prefix;
	 ...
	 */
	public RedisCacheKey(T keyElement) {
	 ...
	 */
	public void setSerializer(RedisSerializer<T> serializer) {
	 ...
	 * @return
	 */
	public RedisCacheKey<T> usePrefix(byte[] prefix) {
		this.prefix = prefix;
		return this;
	}
	 ...
	 * @return
	 */
	public RedisCacheKey<T> withKeySerializer(RedisSerializer<T> serializer) {
