...
public class SrpConnection extends AbstractRedisConnection {
	...
	public Boolean exists(byte[] key) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.exists(key), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.exists(key).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean expire(byte[] key, long seconds) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.expire(key, seconds), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.expire(key, seconds).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean expireAt(byte[] key, long unixTime) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.expireat(key, unixTime), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.expireat(key, unixTime).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean pExpire(byte[] key, long millis) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.pexpire(key, millis), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.pexpire(key, millis).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean pExpireAt(byte[] key, long unixTimeInMillis) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.pexpireat(key, unixTimeInMillis), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.pexpireat(key, unixTimeInMillis).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean persist(byte[] key) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.persist(key), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.persist(key).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean move(byte[] key, int dbIndex) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.move(key, dbIndex), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.move(key, dbIndex).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean renameNX(byte[] oldName, byte[] newName) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.renamenx(oldName, newName), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.renamenx(oldName, newName).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public DataType type(byte[] key) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.type(key), Converters.stringToDataType()));
				return null;
			}
			return Converters.toDataType(client.type(key).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean mSetNX(Map<byte[], byte[]> tuples) {
		try {
			...
			return Converters.toBoolean(client.msetnx((Object[]) SrpConverters.toByteArrays(tuples)).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean setNX(byte[] key, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.setnx(key, value), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.setnx(key, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Double incrBy(byte[] key, double value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.incrbyfloat(key, value), SrpConverters.bytesuble()));
				return null;
			}
			return SrpConverters.uble(client.incrbyfloat(key, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean getBit(byte[] key, long offset) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.getbit(key, offset), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.getbit(key, offset).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean setBit(byte[] key, long offset, boolean value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpGenericResult(pipeline.setbit(key, offset, Converters.toBit(value)),
						SrpConverters.longToBooleanConverter()));
				return null;
			}
			return SrpConverters.toBoolean(client.setbit(key, offset, Converters.toBit(value)));
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean sIsMember(byte[] key, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.sismember(key, value), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.sismember(key, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean sMove(byte[] srcKey, byte[] destKey, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.smove(srcKey, destKey, value), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.smove(srcKey, destKey, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean zAdd(byte[] key, double score, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.zadd(new Object[] { key, score, value }), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.zadd(new Object[] { key, score, value }).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Long zAdd(byte[] key, Set<Tuple> tuples) {
		try {
			...
			args.add(key);
			args.addAll(Converters.toObjects(tuples));
			if (isPipelined()) {
	...
	public Double zIncrBy(byte[] key, double increment, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.zincrby(key, increment, value), SrpConverters.bytesuble()));
				return null;
			}
			return SrpConverters.uble(client.zincrby(key, increment, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Double zScore(byte[] key, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.zscore(key, value), SrpConverters.bytesuble()));
				return null;
			}
			return SrpConverters.uble(client.zscore(key, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean hSet(byte[] key, byte[] field, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.hset(key, field, value), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.hset(key, field, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean hSetNX(byte[] key, byte[] field, byte[] value) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.hsetnx(key, field, value), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.hsetnx(key, field, value).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Boolean hExists(byte[] key, byte[] field) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.hexists(key, field), Converters.longToBoolean()));
				return null;
			}
			return Converters.toBoolean(client.hexists(key, field).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
	...
	public Double hIncrBy(byte[] key, byte[] field, double delta) {
		try {
			if (isPipelined()) {
				pipeline(new SrpResult(pipeline.hincrbyfloat(key, field, delta), SrpConverters.bytesuble()));
				return null;
			}
			return SrpConverters.uble(client.hincrbyfloat(key, field, delta).data());
		} catch (Exception ex) {
			throw convertSrpAccessException(ex);
		}
	}
