...
<html>
  <head>
    ...
    <title><p:msg key="jsp-set_locale.header" p0="Session"/></title>
  ...
  <div align="right">
    ...
    <div align="center">
    	<br><br><br>
    	<span style="font-size: x-small; color:blue;"><p:msg key="jsp-set_locale.notice" p0="Locale Cookie"/></span>
    	<br><br><br>
    	...
    	<c:url var="delete" value="test/testI18N.action">
    	...
    	&nbsp;&nbsp;&nbsp;&nbsp;
    	<a href="${delete}"><p:msg key="jsp-set_locale.delete" p0="Locale Attr"/></a>
    	<br><br>
