...
@DaoBean
public class MyUser2 extends RestActionSupport
{
	// HTML 视图页面需要的属性
	private String name;
	 ...
	 * --------------------
	 * Action Entry:
	 *   -> /test/my-rest-2/my-user-2.action -> execute() -> dispatch : ${jsp-path}/test/my-rest-2/my-user-2.jsp
	 * --------------------
	 * REST Mapping:
	 *   -> GET	  : ""			-> index()
	 *   -> POST  : ""			-> create()
